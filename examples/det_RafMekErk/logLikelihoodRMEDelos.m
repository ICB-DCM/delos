 function [varargout] = logLikelihoodRMEDelos(theta, amiData)
...
% paper by Fiedler et al.
    ...
    try
        ...
        for iCondition = 1 : n_u
            ...
            sol = simulate_rafmekerk_delos(amiData(iCondition).t, theta, amiData(iCondition).condition, amiData(iCondition), amiO);
    ...
    switch (nargout)
        ...
        case 2
            ...
            varargout{2} = sllh;
        case 3
            error('Too many outputs requested from likelihood function.');
    end
